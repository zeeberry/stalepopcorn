<?php include("poll/lp_settings.inc"); ?>
<html>
<head>
...
if ($adminstep==1) {
	if ($p_pwd == $pwd) {
	$adminstep1str='<form action="poll/lp_admin.php" method="post" name="form1">Number of Items:<input type="hidden" name="adminstep" value="'.($adminstep+1).'"><input type="Text" name="numofitems" size="5"><br>Poll Question:&nbsp&nbsp&nbsp&nbsp&nbsp<input type="Text" name="question" size="25"><br><input type="Submit" value="OK"></form>';
	}
else {
